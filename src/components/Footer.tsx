    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">PurrfectCare</span>
            </div>
            <p className="text-sm leading-relaxed">
              Your trusted source for premium cat supplies. Dedicated to keeping your feline friends healthy and happy.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm">support@purrfectcare.com</span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm">123 Pet Lane, Catville, CA 90210</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} PurrfectCare. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
